...
show_url = 'https://airnet.org.au/rest/stations/3pbs/programs/acid-country'
episodes_url = 'https://airnet.org.au/rest/stations/3pbs/programs/acid-country/episodes'
episode_url = 'https://airnet.org.au/rest/stations/3pbs/programs/acid-country/episodes/2019-05-09+15%3A00%3A00'
playlists_url = 'https://airnet.org.au/rest/stations/3pbs/programs/acid-country/episodes/2019-05-09+15%3A00%3A00/playlists'
media_url = 'http://media.emit.com/pbs/acid-country/201904251500/aac_mid.m4a'
...
def all_shows():
    ...
    for show in shows:
        if show['slug'] and not show['archived']:
            shows_data.append((show['name'], "/"+show['slug']))
...
def pbs_show(slug):
    ...
    for episode in episodes:
        ...
        title = f"{show_title} {start_time.date()}"
